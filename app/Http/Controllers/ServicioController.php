            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                           $btn = '<a href="javascript:void(0)" data-toggle="tooltip" 
                                    data-id="'.$row->idS.'" data-original-title="Edit" class="edit btn btn-editar btn-sm editItem"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="26" height="26"
                                    viewBox="0 0 226 226"
                           ...
                           $btn = $btn.' <a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->idS.'" data-original-title="Delete" class="btn btn-eliminar btn-sm deleteItem"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                           width="26" height="26"
                           viewBox="0 0 172 172"
